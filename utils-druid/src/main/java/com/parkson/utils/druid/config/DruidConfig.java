...
public class DruidConfig {
    ...
    public ServletRegistrationBean statViewServlet() {
        ...
        initParas.put("loginUsername", druidProperties.getLoginUsername());//它这个账户密码是固定的
        initParas.put("loginPassword", druidProperties.getLoginPassword());
        //允许谁能防伪
        initParas.put("allow", druidProperties.getAllow());//这个值为空或没有就允许所有人访问，ip白名单
        //initParas.put("allow","localhost");//只允许本机访问，多个ip用逗号,隔开
        initParas.put("deny", druidProperties.getDeny());
    ...
    public FilterRegistrationBean webStatFilter() {
        ...
        //把不需要监控的过滤掉,这些不进行统计
        initParams.put("exclusions", "*.js,*.css,/druid/*,*.ico");
